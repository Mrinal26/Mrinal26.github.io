            ...
            <div className="col-lg-6 col-md-12 d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="profile-links mt-4 d-flex gap-3 justify-content-center">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/Mrinal26"
                  id="contact-github"
                >
                  <i
                    style={{ color: "black" }}
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/mrinal-kumar-227817194/"
                  id="contact-linkedin"
                >
                  <i
                    style={{ color: "black" }}
              ...
              <div className="contact text-center mt-5">
                <p className="b-text" id="contact-email"><i className="fa-solid fa-envelope"></i>: Mrinalkumar5046@gmail.com</p>
                <p className="b-text" id="contact-phone"><i className="fa-solid fa-phone"></i>: 8434082978</p>
              </div>
            </div>
